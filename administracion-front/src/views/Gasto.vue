<template>
  <div>
    <b-row>
      <b-col cols="12">
        <b-card border-variant="primary" header-bg-variant="primary" :header="'<strong>Gestionar Gastos</strong> (' + totalFilas + ')'" tag="article" class="m-3 mt-3">
